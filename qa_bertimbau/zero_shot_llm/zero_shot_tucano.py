...
OUTPUT_FILE = "results/tucano_predictions.json"
MAX_NEW_TOKENS = 64  # Reducido - respuestas extractivas son cortas
MAX_INPUT_LENGTH = 512
BATCH_SIZE = 16  # Tucano 1B es más pequeño, puede usar batch más grande
...
def main():
    ...
    for i in tqdm(range(num_batches), desc="Generating Tucano"):
    ...
    with open("results/tucano_zero_shot_benchmarks.json", "w") as f:
