...
# -----------------------------
MODEL_NAME = "maritaca-ai/sabia-7b"   # ← SABIÁ
OUTPUT_DIR = "./lora_sabia_qa"
...
tokenizer.pad_token = tokenizer.eos_token  # IMPORTANTE para causal LM
