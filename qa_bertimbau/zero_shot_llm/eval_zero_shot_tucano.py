...
from prompts import extractive_prompt  # opcional, solo para referencia

PRED_FILE = "results/tucano_predictions.json"
OUTPUT_FILE = "results/tucano_zero_shot_metrics.json"
...
def main():
    # Cargamos métrica SQuAD
    metric = evaluate.load("squad")

    # Cargamos predicciones generadas
    ...
    print(f"Evaluando {len(predictions)} ejemplos.")
    results = metric.compute(predictions=predictions, references=references)
    
    print("\n RESULTADOS TUCANO ZERO-SHOT")
